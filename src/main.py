...
def main():
    ...
    train_parser.add_argument('-v', '--visualize', action='store_true', help="visualize mode")
    ...
    predict_parser.add_argument('-v', '--visualize', action='store_true', help="visualize mode")
    ...
    if args.command == 'train':
        ...
        Train(args.subject, args.run, visualize=args.visualize)
        return
